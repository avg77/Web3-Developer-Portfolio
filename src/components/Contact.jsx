...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Aviral Gupta",
          from_email: form.email,
          to_email: "work.aviral.gupta@gmail.com",
  ...
  <button
    type='submit'
    className='bg-tertiary py-3 px-8 rounded-xl outline-none w-full text-white font-bold shadow-md shadow-primary hover:bg-[#1a1a2e]'
  >
  ...
  <div className='flex gap-4'>
    <button
      type='button'
      onClick={() => window.open("https://linktr.ee/aviral_gupta", "_blank")}
